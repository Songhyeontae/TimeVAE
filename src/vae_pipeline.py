...
def run_vae_pipeline(dataset_name: str, vae_type: str):
    ...
    print(f"scales_train_data_shape: {scaled_train_data.shape}")
...
if __name__ == "__main__":
    # ../data에 있는 데이터셋 중 선택
    # air_subsampled_train_perc_
    # sine_subsampled_train_perc_
    # energy_subsampled_train_perc_
    # stockv_subsampled_train_perc_
    # web_traffic_dataset_without_missing_values_train_perc_
    dataset = "energy_subsampled_train_perc_5"

    # vae_dense, vae_conv, timeVAE, timeGDVAE 중 선택
